export default function Contatti({ title, imageSrc, imgSfondoCont, subTitle, text, socialLinks }) {
    return (
      <section className="py-16 px-8 mx-auto max-w-screen-lg mt-40 md:mt-96 relative" data-aos="fade-up">
        <h2 className="text-8xl font-bold text-gray-800 pb-4" data-aos="fade-up">{title}</h2>
        ...
        <div className="relative">
          ...
          />
          <div className="absolute bottom-[-75px] right-[-75px] w-1/2 h-2/3 bg-gray-800 hidden md:block"></div>
        </div>
