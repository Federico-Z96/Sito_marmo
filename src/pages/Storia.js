...
export default function Storia({ title, leftImage, video, subTitle, text, buttonLink }) {
    return (
      <section className="py-4 px-8 mx-auto max-w-screen-lg mt-20 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
          ...
          <div className="flex flex-col justify-center ">
            <h3 className="text-2xl font-bold text-gray-800 mb-4 lg:text-left text-center" data-aos="fade-up">
              {subTitle}
            </h3>
            <p className="text-base text-gray-700 mb-4 lg:text-left text-center" data-aos="fade-up">
              {text}
            </p>
            <a
              href={buttonLink}
